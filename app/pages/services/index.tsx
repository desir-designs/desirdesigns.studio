...
const ServicesPage = ({ page }) => {
    ...
    return (
        ...
        <PageLayout {...layout}>
            <section className="relative pt-24 pb-48 overflow-hidden bg-black bg-opacity-10">
                <img
                ...
                <div className="relative z-10 container mx-auto px-4">
                    <div className="md:max-w-3xl md:mx-auto">
                        ...
                        <div className="flex flex-wrap -m-5">
                            ...
                            <div className="w-full md:w-1/2 md:relative md:top-12 p-5 bg-black">
                            ...
                            <div className="w-full md:w-1/2 p-5 bg-black">
