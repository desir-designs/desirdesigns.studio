...
import type { OptionProps } from "@typings/Option"


const Options: ComponentType<OptionProps> = ({ title, heading, bullets }: OptionProps) => {
        ...
        return (
            <div className="max-w-lg text-black">
                ...
                <p className="mb-11 text-gray-400 text-base">
                    {heading ?? "[Client]: HEADING_NOT_FOUND"}
                </p>
                                ...
                                <div className="w-auto p-3">
                                    <div className="flex flex-wrap items-center -m-3">
                                        ...
                                        <div className="w-auto p-3">
                                            ...
                                            <p className="text-gray-400 text-base">$12/month only</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
